...
public class PlayState extends FlxState
{
	...
	public void create()
	{
		...
		s = new FlxSprite(20, 60).loadGraphic(Asset.ImgZombie, true, true, 36, 41);
		...
		s = new FlxSprite(100, 60).loadGraphic(Asset.ImgZombie, true, true, 36, 41);
		...
		_zombie = new FlxSprite(20, 120).loadGraphic(Asset.ImgZombie, true, true, 36, 41);
		...
		// Droid
		s = new FlxSprite(220, 120).loadGraphic(Asset.ImgDroid, true, true, 14, 14);
