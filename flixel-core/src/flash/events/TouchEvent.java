...
{
	/**
	 * Defines the value of the type property of a <code>TOUCH_END</code> touch
	 * event object.
	 */
	static public final String TOUCH_END = "touchEnd";
	/**
	 * Defines the value of the type property of a <code>TOUCH_BEGIN</code>
	 * touch event object.
	 */
	 ...
	 * @param touchPointID A unique identification number (as an int) assigned
	 *        to the touch point.
