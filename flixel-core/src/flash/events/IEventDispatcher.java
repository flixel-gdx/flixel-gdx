...
/**
 * This interface replicates some of the <code>IEventDispatcher</code>
 * functionality from Flash.
 * 
 * @author Ka Wing Chin
...
public interface IEventDispatcher
{
	 ...
	 *        function must accept an Event object as its only parameter and
	 *        must return nothing.
	 ...
	 * 
	 * @param event The <code>Event</code> object that is dispatched into the
	 *        event flow.
	 ...
	 * is no matching listener registered with the EventDispatcher object, a
