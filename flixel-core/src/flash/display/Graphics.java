 ...
 * Display objects that support drawing include Sprite and Shape objects. Each of these classes
 * includes a <code>graphics</code> property that is a Graphics object.
 * 
