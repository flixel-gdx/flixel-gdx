...
/**
 * A Visual Studio-style "watch" window, for use in the debugger overlay. Track
 * the values of any public variable in real-time, and/or edit their values on
 * the fly.
 * 
...
public class Watch extends FlxWindow
{
	...
	/**
	 * Creates a new window object. This Flash-based class is mainly (only?)
	 * used by <code>FlxDebugger</code>.
	 * 
	 * @param Title The name of the window, displayed in the header bar.
	 * @param Width The initial width of the window.
	 * @param Height The initial height of the window.
	 * @param Resizable Whether you can change the size of the window with a
	 *        drag handle.
	...
	/**
	 * Add a new variable to the watch window. Has some simple code in place to
	 * prevent accidentally watching the same variable twice.
	 * 
	 * @param AnyObject The <code>Object</code> containing the variable you want
	 *        to track, e.g. this or Player.velocity.
	 * @param VariableName The <code>String</code> name of the variable you want
	 *        to track, e.g. "width" or "x".
	 * @param DisplayName Optional <code>String</code> that can be displayed in
	 *        the watch window instead of the basic class-name information.
	 */
	 ...
	 * 
	 * @param AnyObject The <code>Object</code> containing the variable you want
	 *        to remove, e.g. this or Player.velocity.
	 * @param VariableName The <code>String</code> name of the variable you want
	 *        to remove, e.g. "width" or "x". If left null, this will remove all
	...
	/**
	 * Update the Flash shapes to match the new size, and reposition the header,
	 * shadow, and handle accordingly. Also adjusts the width of the entries and
	 * stuff, and makes sure there is room for all the entries.
	 */
	@Override
