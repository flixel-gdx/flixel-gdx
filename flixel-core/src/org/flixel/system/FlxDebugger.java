...
public class FlxDebugger extends FlxGroup
{
	...
	/**
	 * Rearrange the debugger windows using one of the constants specified in
	 * FlxG.
	 * 
	 * @param Layout The layout style for the debugger windows, e.g.
	 *        <code>FlxG.DEBUGGER_MICRO</code>.
	 */
	...
	/**
	 * Forces the debugger windows to reset to the last specified layout. The
	 * default layout is <code>FlxG.DEBUGGER_STANDARD</code>.
	 */
