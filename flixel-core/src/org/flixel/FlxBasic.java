 ...
 * <code>FlxGroup</code> extend this class, as do the plugins. Has no size,
 * position or graphical data.
 * 
 * @author Ka Wing Chin
 */
public class FlxBasic
{
	...
	/**
	 * IDs seem like they could be pretty useful, huh? They're not actually used
	 ...
	 * draw to automatically point at the main camera list out in
	 * <code>FlxG</code> unless you already set it. You can also change it
	 * afterward too, very flexible!
	 */
	...
	/**
	 * Convert object to readable string name. Useful for debugging, save games,
	 * etc.
	 */
