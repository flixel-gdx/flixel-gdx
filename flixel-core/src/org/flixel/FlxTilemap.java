...
public class FlxTilemap extends FlxObject
{
	 ...
	 * 
	 * @return	A libgdx <code>Array</code> of <code>FlxPoint</code> nodes.  If the end tile could not be found, then a null <code>Array</code> is returned instead.
	 */
	 ...
	 * @param	Points	A libgdx <code>Array</code> of <code>FlxPoint</code> nodes composing the path from the start to the end, compiled in reverse order.
	 */
	...
	/**
	 * Returns a new libgdx <code>Array</code> full of every map index of the requested tile type.
	 *
	...
	/**
	 * Returns a new libgdx <code>Array</code> full of every coordinate of the requested tile type.
	 * 
	 * @param	Index		The requested tile type.
