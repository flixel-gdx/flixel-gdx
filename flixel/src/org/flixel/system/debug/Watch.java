...
public class Watch extends FlxWindow
{
	 ...
	 */
	public Watch(String Title, float Width, float Height, boolean Resizable, Rectangle Bounds, long BGColor, long TopColor)
	{
	 ...
	 * @param BGColor		What color the window background should be, default is gray and transparent.
	 */
	public Watch(String Title, float Width, float Height, boolean Resizable, Rectangle Bounds, long BGColor)
	{
